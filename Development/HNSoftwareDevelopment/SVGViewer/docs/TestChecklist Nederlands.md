...
| 5   | 8 - Versienummer | Het versienummer word, net zoals bij een build vanuit VS automatisch opgehoogd: YY.MM.DD.xx waarbij xx bij iedere buil;d die dag met 1 wordt opgehoogd | Het versienummer wordt niet automatisch opgehoogd                                                                                                                                                             |      | Bug                                            |
