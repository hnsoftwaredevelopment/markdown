...
When using the delete, the task will remove the specified Resource Group. This is a very destructive operation because any other resources in that resource group will also be deleted. Use with caution.
